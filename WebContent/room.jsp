...
<div class="container shadow p-4 mt-4 mb-4 bg-white rounded">
	...
	<div id="form_div" class="container p-4 mt-4 mb-4 bg-white">
		<MARQUEE behavior="scroll">게임 대기중입니다</MARQUEE>
	</div>
	...
	<div class="row">
	  <div class="col userBox">
	  	...
	  	<div class="container p-4 bg-primary rounded-lg" style="height: 142px;">
		  	홍길동
		  	<p style="font-size: 20px;">000점</p>
	  	</div>
		<button type="button" class="btn btn-outline-primary" onclick="start_game()">시작</button>
	  	<button type="button" class="btn btn-outline-success">준비</button>
	  </div>
	  <div class="col userBox">
	  	<img style="height:100px;"/>
	  	<img src="https://img.icons8.com/external-kiranshastry-solid-kiranshastry/100/343a40/external-user-interface-kiranshastry-solid-kiranshastry-1.png"/>
	  	<div class="container p-4 border border-primary rounded-lg " style="height: 142px;">
	  		이몽룡
		  	<p style="font-size: 20px;">000점</p>
	  	</div>
	  </div>
...
<script>
function start_game(){
	location.href="<%=request.getContextPath()%>/room_playing.jsp"
}
</script>
<!-- jQuery -->
